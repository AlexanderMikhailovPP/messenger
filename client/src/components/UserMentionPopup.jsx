...
export default function UserMentionPopup({ userId, position, onMessage, onClose }) {
    ...
    if (loading) {
        return (
            <div
                className="absolute z-[100] bg-[#1f2225] border border-gray-700 rounded-lg shadow-2xl p-4 w-80"
                style={{
                    top: `${position.top}px`,
    ...
    return (
        <div
            ...
            onMouseEnter={onClose} // Keep popup open when hovering over it
